...
- Security design doc: correct §5's `normalizeCard` claim after the P0 fix; update the §14.1 test count; ~~add I-24…I-31 and a GNAP section when P6 ships, including group routing~~ (done in P6b, §6.3; the §1.5 finding still to add), then I-32 and inbound documents when P9 ships, then I-33 and MAIA symmetry when P11 ships (and regenerate the posted PDF, per the standing rule).
