...
export const ROUTE_FEATURES = Object.freeze({
  ...
  'DELETE /gnap/group/:groupId/continue/:bcast': 'gnap',
  'POST /gnap/group/:groupId/answer/:bcast': 'gnap',
  'GET /gnap/group-interact/:ix': 'gnap',
  'POST /gnap/group-interact/:ix/code': 'gnap',
